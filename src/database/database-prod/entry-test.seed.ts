...
export const entryTestSeedData = [
  ...
  },
  {
    ...
    status: ExamStatus.DRAFT,
    startTime: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000).toISOString(), // 20 days from now
  ...
  },
  {
    ...
    status: ExamStatus.DRAFT,
    startTime: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString(), // 15 days from now
  ...
  },
  {
    ...
    questionSetTitles: ['Thi học sinh giỏi Sinh học 11 - Cấp thành phố'],
    status: ExamStatus.DRAFT,
    startTime: new Date(Date.now() + 23 * 24 * 60 * 60 * 1000).toISOString(), // 23 days from now
    endTime: new Date(Date.now() + 47 * 24 * 60 * 60 * 1000).toISOString() // 57 days from now
  },
  {
    ...
    status: ExamStatus.DRAFT,
    startTime: new Date(Date.now() + 26 * 24 * 60 * 60 * 1000).toISOString(), // 26 days from now
  ...
  },
  {
    ...
    endTime: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000).toISOString() // 90 days from now
  },
  {
