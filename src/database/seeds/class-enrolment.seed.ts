...
// This will be used to enroll students in classes for testing the student grade list API

export const classEnrolmentSeedData = [
  {
    studentEmail: 'student1@example.com', // Will be replaced by actual student ID
    classCode: 'SINH12-SCHOOL-2024', // Will be replaced by actual class ID
